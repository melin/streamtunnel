...
/**
 * Created by admin on 2020/5/7 6:31 下午
 */
public class JMXClient {
    ...
    private static final Map<String, JMXClient> cache = Collections.synchronizedMap(new HashMap<String, JMXClient>());
    ...
    private JMXClient(String hostName, int port, String userName, String password) throws JMXClientException {
        ...
        try {
            String url = "service:jmx:rmi:///jndi/rmi://" + this.hostName + ":" + this.port + "/jmxrmi";
            this.address = new JMXServiceURL(url);
    ...
    private synchronized void tryReconnect() throws JMXClientException {
    ...
    private void checkSslConfig() throws IOException {
        ...
        try {
            ...
            try {
                ...
                throw (IOException) new IOException(nbe.getMessage(), nbe);
            }
        } catch (IOException e) {
